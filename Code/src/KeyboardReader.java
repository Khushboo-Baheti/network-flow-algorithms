 ...
 * <p>
 * This class is intended for beginning Java programmers. It constructs the
 * necessary buffered reader, converts strings to numbers, and handles
 * exceptions.
 * <p>
 * The methods in this class are <b>static</b> methods. This means that they can
 * be invoked using the class name, without needing to create a
 * <i>KeyboardReader</i> object.
 * <p>
 * The following examples illustrate how to use this class to read from the
 * keyboard:
 * 
 * <pre>
 ...
 * </pre>
 * 
 * This class also defines return values to indicate end-of-information (EOI)
 * and data conversion errors.
 * <p>
 * The default behavior of the <i>readInt()</i> and <i>readDouble()</i> methods
 * is to write a comment to the screen in response to inappropriate data. This
 * behavior may be controlled by the <i>ERROR_MESSAGES</i> field.
 * <p>
 * 
 * @author Bill Conlen
 */
...
public class KeyboardReader {
	...
	/**
	 * Controls the output of error messages to the console in response to
	 * inappropriate input.
	 */
	 ...
	 * 
	 * @return the integer that the user typed, or EOI_INT to indicate
	 *         end-of-information, or ERROR_INT to indicate a conversion or I/O
	 *         error.
	 */
	 ...
	 * <p>
	 * 
	 * @return the number that the user typed, or EOI_DOUBLE to indicate
	 *         end-of-information, or ERROR_DOUBLE to indicate a conversion or
	 *         I/O error.
	 */
	 ...
	 * <p>
	 * 
	 * @return the line of input that the user typed, or EOI_STRING to indicate
	 *         end-of-information, or ERROR_STRING to indicate a conversion or
	 *         I/O error.
	 */
	 ...
	 * <p>
	 * This method would not normally be invoked by users of the KeyboardReader
	 * class.
	 */
